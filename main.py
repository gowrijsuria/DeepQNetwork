...
parser.add_argument('--gamma',                   action='store', type=int, default=0.999, help='future reward discount')
parser.add_argument('--epsilon_start',           action='store', type=int, default=0.9, help='start epsilon')
parser.add_argument('--epsilon_stop',            action='store', type=int, default=0.05, help='stop epsilon')
parser.add_argument('--epsilon_decay',           action='store', type=int, default=250, help='epsilon decay')
parser.add_argument('--threshold_dist',          action='store', type=int, default=2)
...
parser.add_argument('--reward_average_window',   action='store', type=int, default=5)
parser.add_argument('--averageRewardThreshold',  action='store', type=int, default=3000)
...
parser.add_argument('--start_z',          action='store', type=int, default=0.1)
...
parser.add_argument('--reward_collision', action='store', type=int, default=-100)
parser.add_argument('--screen_height',    action='store', type=int, default=100)
parser.add_argument('--screen_width',     action='store', type=int, default=100)

# Agent parameters
parser.add_argument('--targetVel', action='store', type=int, default=10, help='rad/s')
parser.add_argument('--maxForce',  action='store', type=int, default=100)

# Default parameters
parser.add_argument('--lr',         action='store', type=int,default=0.001)
parser.add_argument('--step_size',  action='store', type=int,default=20)
parser.add_argument('--LR_gamma',   action='store', type=int,default=0.1)
...
scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[10, 20, 40, 80, 100], gamma=args.LR_gamma)
